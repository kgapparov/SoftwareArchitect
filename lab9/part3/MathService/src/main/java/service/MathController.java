...
public class MathController {
    ...
    public String checkOddAndEven(@RequestParam("number1") Integer number1,
    ...
    @GetMapping("/add")
    public String checkSum(@RequestParam("value1") Integer number1,
                           @RequestParam("value2") Integer number2) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.add("Content-Type", "application/json");
